...
('Insigna trupa metal inoxidabil', 'O insigna de mare calitate fabricata dintr-un aliaj de metal inoxidabil. Aceasta ia forma numelui trupei Prea Tarziu.', 'pin-gri-trupa.png', 'Accesorii', 'metal', 50, 10, 0.01, '{"gri"}', False),
('Sapca logo trupa alb', 'O sapca calitativa, cu logo-ul trupei cusut in partea sa frontala. Cozoroc drept si banda de reglaj.', 'sapca-neagra-trupa.png', 'Imbracaminte', 'tesatura',60 , 30, 0.08, '{"negru","alb","rosu"}', True),
('Sticla din aluminiu maini', 'Sticla fabricata din aluminiu. Modelul imprimat este realizat chiar de un membru al trupei.', 'sticla-de-apa-generica.png', 'Accesorii', 'metal',70 , 60, 0.2, '{"alb","rosu","negru"}', False),
('Triocu craniu si masca de gaze', 'Tricou de calitate inalta fabricat in Romania. 100% combed, organic, Indian, fair trade, climate neutral.', 'tricou-generic-galben-gri.png', 'Imbracaminte', 'tesatura', 80, 30, 0.1, '{"negru","galben","gri"}', True),
...
('Deschizator de sticle sarpe', 'Deschizator de sticle cu unul dintre logo-urile trupei.', 'plastic-bottle-opener.png', 'Accesorii', 'plastic', 25, 0, 0.01, '{"alb","negru"}', False),
...
('Tricou Relentless Mutation', 'Tricou de calitate inalta fabricat in Romania. 100% combed, organic, Indian, fair trade, climate neutral.', 'tricou-relentless.png', 'Imbracaminte', 'tesatura', 90, 30, 0.1, '{"negru","gri","albastru"}', True),
('Geaca de piele Ride The Lightning', 'Geaca de calitate inalta fabricata in Italia. Realizata cu atentie si dedicatie de maestrii Italiei.', 'leather-jacket-band.png', 'Imbracaminte', 'piele', 600, 365, 0.6, '{"negru","alb"}', False),
...
('Sticker logo trupa rosu', 'Nu e prea tarziu sa iti lipesti un sticker fenomenal pe laptop, sticla de apa sau pe orice alt obiect din casa ta.', 'sticker-trupa-rosu.png', 'Printate', 'hartie', 10, 0, 0.01, '{"rosu","negru","alb"}', False),
...
('Patch cu logo-ul trupei alb-negru', 'Creat sa umple cu stil acel loc liber de pe vesta ta de blugi.', 'patch-trupa-havok.png', 'Accesorii', 'tesatura', 30, 15, 0.02, '{"alb","negru"}', True),
...
('Tricou Weapons of Tomorrow', 'Tricou de calitate inalta fabricat in Romania. 100% combed, organic, Indian, fair trade, climate neutral.', 'tricou-album-weapons.png', 'Imbracaminte', 'tesatura', 80, 30, 0.1, '{"negru","albastru"}', True);
