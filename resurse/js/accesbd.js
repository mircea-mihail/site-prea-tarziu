...
class AccesBD{
    ...
    //vrem sa protejam constructorul, intrucat este public
    constructor() {
        if(AccesBD.#instanta){
    ...
    initLocal(){
        this.client= new Client({database:"db_prea_tarziu",
            user:"mihail",
            password:"mihail",
            host:"localhost",
            port:5432});
        // this.client2= new Pool({database:"db_prea_tarziu",
        //     user:"mihail", 
        //     password:"mihail", 
        //     host:"localhost", 
        //     port:5432});
    ...
    //init -> credentiale locale sau pt site-ul de hosting
    static getInstanta({init="local"}={}){ 
        // accesBD.getInstanta() -> obiect vid (nu a primit o valoare pt init)
        // puntem avea si accessBd.getInstanta({init:"render"}) 
        ...
        if(!this.#instanta){
            ...
            try{
                switch(init){
                    ...
                    // cand punem site-ul pe net punem alte caseuri
                    //trebuie functii diferite pt baza de date cand o incarcam altundeva 
                    //      -> alte chestii de securitate
                    //      -> alte credentiale
                }
    ...
    // metode specifice bazelor de date, implementate in clasa asta accessBD
    // un obiect cu tabelul pe care facem select, campurile (utilizatori) si conditiile dupa care facem selectul
    // pt or: vector de contitii
    //      in loc de vector conditiiAnd avem conditii
    ...
    //pt aceasta functie nu pot astepta raspunsul -> asteapta rezultatul
